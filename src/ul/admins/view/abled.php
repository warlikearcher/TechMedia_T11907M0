...
<div class="delete-body">
    <div class="delete-top-bar padding-0">
        <div class="banner-top top-content-delete shadow">
            <div class="card-body">
                <div class=" no-gutters align-content-center-delete">
                    <div class="card-font">
                        <h1>Bạn thật sự muốn hiệu hóa:</h1>
                        <h2><?php echo $name; ?></h2>
                    </div>
                </div>
            </div>
        ...
        <div>
            <form action="./config/model/run_abled.php">
                <input type="hidden" name="hidden_abled_id" value="<?php echo $id; ?>" />
                <button class="btn btn-danger btnSubmit_delete">Hiệu hóa</button>
            </form>
