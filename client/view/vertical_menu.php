    ...
    <div class="container">
        <div class="row">
                                ...
                                <div class="sub-nav padding-0">
                                    <div class="sub-menu grid-container">
                                        ...
                                        <div class="line-2 grid-item item2">
                                            <h3>Giá khoảng từ</h3>
                                            <ul>
                                                <li><a  href="?view=product&ref=laptop500">Dưới 10 triệu</a></li>
                                                <li><a  href="?view=product&ref=laptop1000">Từ 10 triệu đến 20 triệu</a></li>
                                                <li><a  href="?view=product&ref=laptop2000">Từ 20 triệu đến 40 triệu</a></li>
                                                <li><a  href="?view=product&ref=laptop3000">Trên 40 triệu</a></li>
                                            </ul>
                                        </div>
                                    ...
                                    <div class="sub-menu">
                                        ...
                                        <div class="line-2 grid-item item2">
                                            ...
                                            <ul>
                                                ...
                                                <li><a  href="?view=product&ref=pccase12">Từ 1 đến 2 triệu</a></li>
                                                <li><a  href="?view=product&ref=pccase23">Từ 2 đến 3 triệu</a></li>
                                ...
                                <div class="sub-nav">
                                    <div class="sub-menu">
                                        <div class="line-1 grid-item item1">
                                            <h3>Theo giá</h3>
                                            <ul>
                                                <li><a  href="?view=product&ref=radiator">Razer</a></li>
                                                <li><a  href="?view=product&ref=radiator">Logitech</a></li>
                                                <li><a  href="?view=product&ref=radiator">SteelSerie</a></li>
                                                <li><a  href="?view=product&ref=radiator">E-Dra Serie</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="sub-nav">
                                    <div class="sub-menu">
                                        <div class="line-1 grid-item item1">
                                            <h3>bluetooth</h3>
                                            <ul>
                                                <li><a  href="?view=product&ref=speak">Razer</a></li>
                                                <li><a  href="?view=product&ref=speak">Logitech</a></li>
                                                <li><a  href="?view=product&ref=speak">SteelSerie</a></li>
                                                <li><a  href="?view=product&ref=speak">E-Dra Serie</a></li>
                                            </ul>
                                        </div>
                                        <div class="line-2 grid-item item2">
                                            <h3>Dây</h3>
                                            <ul>
                                                <li><a  href="?view=product&ref=speak">Common</a></li>
                                            </ul>
                                        </div>
                                        <div class="line-2 grid-item item3">
                                            <h3>Giá khoảng từ</h3>
                                ...
                                <div class="sub-nav">
                                    <div class="sub-menu">
                                        ...
                                        <div class="line-2 grid-item item3">
                                            <h3>Giá khoảng từ</h3>
                                            <ul>
                                                <li><a  href="?view=product&ref=graphics1">Dưới 1 triệu</a></li>
                                                <li><a  href="?view=product&ref=graphics13">Từ 1 đến 3 triệu</a></li>
                                                <li><a  href="?view=product&ref=graphics3h">Trên 3 triệu</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="col-md-9 padding-0">
                <?php
                    include 'client/view/carousel_slide.php';
                ?>
            </div>
        </div>
    </div>
