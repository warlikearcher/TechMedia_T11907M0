                            ...
                            <table class="table table-bordered">
                                ...
                                <?php while ($rowItem = mysqli_fetch_array($r)) { ?>
                                    <tr>
                                        ...
                                        <td style="text-align:center;"><a href="index.php?action=remove&id=<?php echo $rowItem["code"]; ?>" class="fa fa-close">Xóa</a></td>
                                    </tr>                  
                                    <?php
                            ...
                            <div class="col-md-6 promo_area">
                                <form method="post">
                                    <div class="input_promo_code">
                                        ...
                                        <input class="promo_in" name="promo_code" <?php
                                        if (isset($code_promo)) {
                        ...
                        <div class="button_sub">
                            ...
                            <form method="post" action="?view=payment">
                                <?php if (isset($code_promo)) { ?>
                                    <input class="total_pro" type="hidden" name="total_promo_code" id="total_promo_code" value="<?php echo $code_promo; ?>">
                                <?php } ?>
                            ...
                            <div class="col-md-6 promo_area">
                                <form method="post">
                                    <div class="input_promo_code">
                                        ...
                                        <?php if (!isset($_SESSION["user-email"])) { ?>
                                            <input class="promo_in" name="promo_code" disabled>
                                            <button class=" btn-danger" name="add_promo" type="submit" disabled>Xác nhận</button>
